...
function initMap() {
    map = L.map('map').setView([41.10424, 29.01802], 4); // Default center
...
(function() {
    ...
    const myBtnsArr = [
        { class: 'myBtn', id: 'button1', content: 'Battle', divId: 'battle' },
        { class: 'myBtn', id: 'button2', content: 'Submarine', divId: 'submarine' },
        { class: 'myBtn', id: 'button3', content: 'Japanese', divId: 'japanese' },
    ];
